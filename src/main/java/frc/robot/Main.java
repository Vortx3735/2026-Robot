...
public final class Main {
  ...
  public static void main(String... args) {
    ...
    //           0.5705211856, // exit height from floor, measure from CAD (top of the flywheel)
    ...
    //           6000,
    //           25,
    //           5.0 // RPM range, search iters, max sim time
    //           );
    ...
    //     if (entry.reachable()) {
    //       System.out.printf(
    //           "shotLUT.put(%.2f, new ShotParameters(%.0f, %.3f));\n",
